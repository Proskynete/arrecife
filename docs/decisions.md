...
## 23 · The footer's caret blinks · REVERSED in § 45
...
**It was never unknown.** `docs/brand-manual.md` § 08 · Voz y tono opens with
...
the moment the page is opened, and `docs/migration-0.8.md` says so. `className`
