...
[§ 33](../decisions/033-doctor-command.md).
...
[§ 26](../decisions/026-social-icons-twice.md).
...
[§ 35](../decisions/035-icon-tone-axis.md).
...
render. See [§ 29](../decisions/029-adopts-phosphor.md).
...
direction. See [§ 29](../decisions/029-adopts-phosphor.md).
...
sand. See [§ 31](../decisions/031-stat-neutral-tone.md).
...
menu or a «Entrar» button. See [§ 30](../decisions/030-nav-compact-size.md).
...
three pixels apart. See [§ 37](../decisions/037-focus-ring-utility.md).
